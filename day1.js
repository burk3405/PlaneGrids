(function() {
  ...
  function main() {
    ...
    const cellContents = [
        ...
        '<img src="manufacturers/airbus.png" alt="Airbus" style="width:120px;height:120px;">',
        'Twin-engine',
        '<img src="manufacturers/boeing.png" alt="Boeing" style="width:126px;height:28px;">',
        // Left column (excluding top-left)
        '<img src="operators/emirates.png" alt="Emirates" style="width:128px;height:88px;">',
        '<img src="operators/singapore-airlines.png" alt="Singapore Airlines" style="width:128px;height:128px;">',
        '<img src="operators/qantas.png" alt="Qantas Airways" style="width:132px;height:83px;border-radius:0px;">'
    ];

    // Tooltip messages for each non-interactive cell (excluding rarity cell)
    const cellTooltips = [
        "Manufacturered by Airbus.",
        "Any Twin-engine aircraft.",
        "Manufacturered by Boeing.",
        "Currently being operated by Emirates, not including any associates or subsidiaries.",
        "Currently being operated by Singapore Airlines, not including any daughter companies or wholly owned subsidiaries (e.g., Scoot).",
        "Currently being operated by Qantas, not including anydaughter companies or wholly owned subsidiaries (e.g., QantasLink, Jetstar, Jetconnect)."
    ];
