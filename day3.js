(function() {
  ...
  function main() {
    ...
    const cellContents = [
        'Widebody',
        'Narrowbody',
        'Regional', // Add (AKA) Mitsubishi to the Hover text
        // Left column (excluding top-left)
        '<img src="operators/lufthansa.png" alt="Lufthansa" style="width:165px;height:110px;border-radius:0px;">',
        '<img src="operators/airfrance.png" alt="Air France" style="width:165px;height:110px;border-radius:0px;">',
        '<img src="operators/klm.png" alt="KLM" style="width:90px;height:52px;border-radius:0px;">'
    ];

  // Tooltip messages for each non-interactive cell (excluding rarity cell)
    const cellTooltips = [
        "Any widebody aircraft.",
        "Any narrowbody aircraft.",
        "Any regional aircraft.",
        "Currently being operated by Lufthansa, Lufthansa CityLine, or Lufthansa City Airlines.",
        "Currently being operated by Air France or Air France Hop. Not including Air France Cargo, Tranavia France or Servair.", //Transavia France + Servair
        "Currently being operated by KLM or KLM Cityhopper."
    ];
    ...
    const rowAttributes = ['Lufthansa', 'Air France', 'KLM'];
    const colAttributes = ['Widebody', 'Narrowbody', 'Regional'];

    // Example: [row][col] = count
    const possibleAircraftCounts = [
        [8, 6, 1], // Row 0: Lufthansa x [Widebody, Narrowbody, Regional]
        [5, 6, 2], // Row 1: Air France x [Widebody, Narrowbody, Regional]
        [6, 4, 3]  // Row 2: KLM x [Widebody, Narrowbody, Regional]
    ];

    const validOptions = [
        // Row 0: Lufthansa
        [
            ["Airbus A330-300", "Airbus A340-300", "Airbus A340-600", "Airbus A350-900", "Airbus A380-800", "Boeing 747-400", "Boeing 747-8i", "Boeing 787-9"], // Lufthansa x Widebody
            ["Airbus A319-100", "Airbus A320-200", "Airbus A320neo", "Airbus A321-100", "Airbus A321-200", "Airbus A321neo"],   // Lufthansa x Narrowbody
            ["Bombardier CRJ900"]                 // Lufthansa x Regional
        ],
        // Row 1: Air France
        [
            ["Airbus A330-200", "Airbus A350-900", "Boeing 777-200ER", "Boeing 777-300ER", "Boeing 787-9"],    // Air France x Widebody
            ["Airbus A220-300", "Airbus A318-100", "Airbus A319-100", "Airbus A320-200", "Airbus A321-100", "Airbus A321-200"], // Air France x Narrowbody
            ["Embraer 170", "Embraer 190"]  // Air France x Regional
        ],
        // Row 2: KLM
        [
            ["Airbus A330-200", "Airbus A330-300", "Boeing 777-200ER", "Boeing 777-300ER", "Boeing 787-9", "Boeing 787-10"],  // KLM x Widebody
            ["Airbus A321neo","Boeing 737-700","Boeing 737-800", "Boeing 737-900"], // KLM x Narrowbody
            ["Embraer 175", "Embraer 190", "Embraer 195-E2"]                          // KLM x Regional
        ]
    ];
    ...
    const airlineAircraftCounts = {
        "Lufthansa": {
            ...
            "Boeing 747-8i": 19,
            "Boeing 787-9": 5,
            "Airbus A319-100": 51, // 35 Lufthansa + 12 Lufthansa CityLine + 4 Lufthansa City
            "Airbus A320-200": 49,
            "Airbus A320neo": 40, // 35 Lufthansa + 2 Lufthansa CityLine + 3 Lufthansa City
            "Airbus A321-100": 17,
            "Airbus A321-200": 37,
            "Airbus A321neo": 17,
            "Bombardier CRJ900": 25 // 25 Lufthansa CityLine
            // ...add other Lufthansa aircraft as needed
        },
        "Air France": {
            "Airbus A330-200": 10, 
            "Airbus A350-900": 37, 
            ...
            "Airbus A321-100": 4, 
            "Airbus A321-200": 10,                                         
            "Embraer 170": 13, // 13 Air France Hop
            "Embraer 190": 23 // 23 Air France Hop
            // ...add other Air France aircraft as needed
        },
        "KLM": {
            "Airbus A330-200": 6, 
            "Airbus A330-300": 5, 
            ...
            "Boeing 787-9": 13, 
            "Boeing 787-10": 12,
            "Embraer 175": 17, // 17 KLM Cityhopper
            "Embraer 190": 28, // 28 KLM Cityhopper
            "Embraer 195-E2": 23 // 23 KLM Cityhopper
            // ...add other KLM aircraft as needed
        }
    ...
    const nameToImage = {
        ...
        "Airbus A220-300": "images/a220-300-airbus.png", 
        "Airbus A318-100": "images/a318-100-airbus.png", 
        "Airbus A319-100": "images/a319-100-delta.png", 
        "Airbus A320-200": "images/a320-200-lufthansa.png",
        "Airbus A320neo": "images/a320neo-airbus.png",
        "Airbus A321-100": "images/a321-100-lufthansa.png",
        "Airbus A321-200": "images/a321-200-delta.png", 
        "Airbus A321neo": "images/a321neo-airbus.png",
        "Airbus A340-300": "images/a340-300-airbus.png",
        "Airbus A340-600": "images/a340-600-airbus.png",
        "Boeing 737-700": "images/737-700-southwest.png",
        "Boeing 737-900": "images/737-900-delta.png", 
        "Boeing 747-400": "images/747-400-lufthansa.png",
        "Boeing 747-8i": "images/747-8i-korean.png",
        "Boeing 777-200ER": "images/777-200er-airfrance.png",  
        "Bombardier CRJ900": "images/crj900-delta.png",                                 
        "Embraer 170": "images/e-170-delta.png",
        "Embraer 190": "images/e-190.png",
        "Embraer 175": "images/e-175-delta.png",
        "Embraer 195-E2": "images/e-195.png"
    };
